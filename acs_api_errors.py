...
ACS_PROVIDER_BUDGET_EXHAUSTED = "ACS_PROVIDER_BUDGET_EXHAUSTED"
...
CODES = (
    ...
    ACS_RATE_LIMITED, ACS_PROVIDER_BUDGET_EXHAUSTED, ACS_TIMEOUT, ACS_NOT_CONFIGURED, ACS_INTERNAL,
...
HTTP_STATUS = {
    ...
    ACS_PROVIDER_BUDGET_EXHAUSTED: 422,
    ACS_TIMEOUT: 504,
...
MESSAGE_AR = {
    ...
    ACS_PROVIDER_BUDGET_EXHAUSTED: "بلغ المقترح حد الاستدعاءات الذي وافقت عليه قبل اكتمال المخطط. لم يبدأ استدعاء إضافي.",
