...
const order=['shared/authoring.js','shared/model.js','shared/building.js','shared/layout-quality.js','shared/ifc.js','shared/geometry.js','src/renderer.js','src/storage.js','shared/render-scene.js','src/material-downloads.js','src/render-ui.js','src/room-review.js','src/plan-inspection.js','src/app.js'];
