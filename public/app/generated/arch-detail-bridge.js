/* ============================================================
   ...
   ============================================================ */
import { THREE, getMat, getTex } from '../core/viewer.js';
import { ACS_ARCHDETAIL_SPEC, AD, adCaptureMetadata, adIssue, adLed, adMaterial, adObjectAuthority, adObjectRecipe, adPlacement, adVariation, adWindowAssembly } from './arch-detail.js';
import { _pqDescribe } from './pbr-bridge.js';
import { pqBoundsMember } from './pbr.js';
...
export { _adBounds, _adBuildingMeshes, _adClearAll, _adContext, _adExteriorWalls, _adFacade, _adGrp, _adLedStrips, _adMatFromSpec, _adOwnedMat, _adSaveMat, _adWindowFrames };
