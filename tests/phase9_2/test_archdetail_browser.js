...
/* §42/§47 — كان هذا القسم داخل فرع الـDOM فلا يعمل إلّا في متصفّح حقيقي مع أنه
   فحص مصدر بحت. أُخرِج منه فصار يعمل في Node أيضاً (وهو ما تشغّله السلسلة غير
   المتّصلة)، وأُعيد توجيهه من نصّ الصفحة إلى شيفرة التطبيق بعد F-09. */
...
(function(){
  ...
  const layer=APPSRC.block('generated/arch-detail.js',_ab,_ae)
             +APPSRC.block('generated/arch-detail-bridge.js',_bb,_be);
