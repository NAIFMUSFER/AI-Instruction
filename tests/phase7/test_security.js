...
(function(){
  /* بعد F-09 صارت الكتلة المولَّدة وحدة ES مستقلّة لا مقطعاً في الصفحة: تُفحَص
     العلامة في شيفرة التطبيق كلّها (مرّة واحدة)، وتُثبَت الوحدة الحاملة لها،
     ويُثبَت أن public/app/main.js يستوردها فعلاً. */
  const APPSRC=require(_np.join(ROOT,'tests','phase3','lib_app_files.js'));
  const MOD='generated/render-engine.js';
  const B='/* ===== ACS RENDER ENGINE (generated by tools/build_render_browser.py) ===== */';
  const E='/* ===== END ACS RENDER ENGINE ===== */';
  chk('the generated render block appears exactly once in the whole application',
