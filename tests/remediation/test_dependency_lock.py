...
if exists('.gitignore'):
    gi = rd('.gitignore')
    chk('.gitignore does NOT ignore node_modules (it is committed on purpose)',
        not re.search(r'^\s*/?node_modules/?\s*$', gi, re.M))
    chk('.gitignore says why node_modules is left tracked',
        'node_modules' in gi)
