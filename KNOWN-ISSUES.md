...
| first-party JavaScript, all modules | **1,956,378 B in 31 modules** |
| evaluated on first load (core + boot) | **1,490,509 B** |
|   of which core modules | **1,462,615 B in 19 modules** |
