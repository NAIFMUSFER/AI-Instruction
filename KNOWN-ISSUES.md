...
| AUDIT-C13: موضع فتحة SVG يكرر إضافة أصل الجدار | مفتوح، شاهد مستقل مثبت | acs_docs.py:432 ومرآته: باب مركزه [13,5] يظهر حول [23,5]. evidence/svg-opening-origin/result.json؛ يحتاج اختباراً وإصلاحاً مستقلاً |
...
آخر تشغيل كامل بعد C09c: 127 ملف اختبار، 112 نجاح / 7 فشل / 8 غير متحققة.
...
المقارنة النهائية أبقت هندسة الحالتين بايتاً؛ نتائج التحقق تغيرت كما هو مفصل في التقرير،
