...
| first-party JavaScript, all modules | **2,117,855 B in 41 modules** |
| evaluated on first load (core + boot) | **1,651,986 B** |
|   of which core modules | **1,599,526 B in 29 modules** |
