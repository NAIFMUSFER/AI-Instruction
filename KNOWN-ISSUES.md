...
| first-party JavaScript, all modules | **2,118,232 B in 41 modules** |
| evaluated on first load (core + boot) | **1,652,363 B** |
|   of which core modules | **1,599,903 B in 29 modules** |
