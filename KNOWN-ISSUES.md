...
| first-party JavaScript, all modules | **2,072,870 B in 38 modules** |
| evaluated on first load (core + boot) | **1,607,001 B** |
|   of which core modules | **1,560,699 B in 26 modules** |
