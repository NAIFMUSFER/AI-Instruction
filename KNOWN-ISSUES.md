...
| first-party JavaScript, all modules | **1,944,706 B in 29 modules** |
| evaluated on first load (core + boot) | **1,478,837 B** |
|   of which core modules | **1,450,943 B in 17 modules** |
