...
| | |
|---|---|
| index shell (`public/index.html`) | **47,424 B** |
| first-party JavaScript, all modules | **1,922,487 B in 27 modules** |
| evaluated on first load (core + boot) | **1,456,618 B** |
|   of which core modules | **1,431,069 B in 15 modules** |
