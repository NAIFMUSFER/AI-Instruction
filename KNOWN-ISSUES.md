...
| first-party JavaScript, all modules | **2,079,384 B in 38 modules** |
| evaluated on first load (core + boot) | **1,613,515 B** |
|   of which core modules | **1,561,055 B in 26 modules** |
