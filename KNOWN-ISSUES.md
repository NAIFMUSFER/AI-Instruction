...
| AUDIT-C09a: glTF يستبدل المضلع بمستطيل | أُصلح في مصدر glTF؛ بقية C09 مفتوحة | test_polygon_gltf.py: 6 اختبارات؛ مساحة L الفعلية 20 م² وطرح فراغ النواة، جدران مائلة وفتحات، حفظ الأصل ورفض الحلقة المتقاطعة. العرض وSVG/IFC والمدقق والمستورد لم تُغلق بعد |
| AUDIT-C09b: العرض يستبدل المضلع ويغير حافة الباب | أُصلح في هندسة Three؛ البكسلات غير متحققة | test_polygon_meshes.js: 8 اختبارات على مثلثات فعلية، فتحة النواة والتشطيبات والحافة المائلة وعدم تعديل المدخل؛ تكافؤ Python/JS وحارس تعقيد مشترك. نجح بناء Netlify؛ المعمار وSVG/IFC والمدقق والمستورد ما زالت مفتوحة |
...
آخر تشغيل كامل بعد C09b: 125 ملف اختبار، 110 نجاح / 7 فشل / 8 غير متحققة.
