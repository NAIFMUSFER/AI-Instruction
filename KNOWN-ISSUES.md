...
| first-party JavaScript, all modules | **2,127,361 B in 41 modules** |
| evaluated on first load (core + boot) | **1,661,492 B** |
|   of which core modules | **1,609,032 B in 29 modules** |
