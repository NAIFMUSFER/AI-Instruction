...
| first-party JavaScript, all modules | **1,924,827 B in 27 modules** |
| evaluated on first load (core + boot) | **1,458,958 B** |
|   of which core modules | **1,431,064 B in 15 modules** |
