...
منتج منشور عند هذا التحديث هو C09f: 47ac0fe18acc7367df562949f3e7dfcbd569add3.
...
| AUDIT-C20: مقترح IFC يستهدف غرفة في الدور الخطأ | مفتوح ومثبت | غرفتان فوق بعضهما بأسماء مختلفة؛ استيراد الملف نفسه يقترح تغيير اسم العلوية باسم السفلية. الخريطة تعتمد X/Z دون المنسوب؛ C20/diff-before.json |
| AUDIT-C09g: مساحة فرق IFC تعود للصندوق | مفتوح ومثبت | L محفوظة20م² بعد C09f، لكن diff يقترح مساحتها36م²؛ C09g/diff-before.json |
...
آخر تشغيل كامل بعد C19: 140 ملف اختبار، 125 نجاح / 7 فشل / 8 غير متحققة.
