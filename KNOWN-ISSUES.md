...
| first-party JavaScript, all modules | **2,099,891 B in 39 modules** |
| evaluated on first load (core + boot) | **1,634,022 B** |
|   of which core modules | **1,581,562 B in 27 modules** |
