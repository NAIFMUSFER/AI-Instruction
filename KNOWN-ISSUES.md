...
| first-party JavaScript, all modules | **1,982,693 B in 32 modules** |
| evaluated on first load (core + boot) | **1,516,824 B** |
|   of which core modules | **1,480,278 B in 20 modules** |
