...
| first-party JavaScript, all modules | **2,071,457 B in 38 modules** |
| evaluated on first load (core + boot) | **1,605,588 B** |
|   of which core modules | **1,559,286 B in 26 modules** |
| deferred until a panel is opened | **465,869 B in 6 modules** |
| share of first-party JS deferred | **22.5 %** |
