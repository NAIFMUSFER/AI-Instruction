...
| first-party JavaScript, all modules | **2,129,471 B in 41 modules** |
| evaluated on first load (core + boot) | **1,663,602 B** |
|   of which core modules | **1,611,142 B in 29 modules** |
