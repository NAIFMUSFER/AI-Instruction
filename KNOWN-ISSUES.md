...
منتج منشور عند هذا التحديث هو C15: 830adcc4c98ac3440cd9f343174a6785d0216857.
...
| AUDIT-C17/C18: قواعد EXPRESS في IFC | مفتوحة ومثبتة مستقلاً | الغرف في containment خاطئ؛ جدران StandardCase بلا طبقات مواد. 6 أخطاء متبقية في العينة بعد C16 |
...
آخر تشغيل كامل بعد C16: 134 ملف اختبار، 119 نجاح / 7 فشل / 8 غير متحققة.
