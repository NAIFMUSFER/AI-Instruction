...
| first-party JavaScript, all modules | **2,117,890 B in 41 modules** |
| evaluated on first load (core + boot) | **1,652,021 B** |
|   of which core modules | **1,599,561 B in 29 modules** |
