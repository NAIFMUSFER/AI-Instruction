...
| first-party JavaScript, all modules | **2,092,460 B in 39 modules** |
| evaluated on first load (core + boot) | **1,626,591 B** |
|   of which core modules | **1,574,131 B in 27 modules** |
