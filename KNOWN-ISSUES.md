...
| first-party JavaScript, all modules | **2,080,195 B in 38 modules** |
| evaluated on first load (core + boot) | **1,614,326 B** |
|   of which core modules | **1,561,866 B in 26 modules** |
