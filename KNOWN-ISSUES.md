...
منتج منشور عند هذا التحديث هو C18: ad4c0e067321c2c657a1673e2453033df2b72348.
...
| AUDIT-C09e: حدود المضلع في نموذج التبادل وIFC | أُصلح في المصدر والمرآة والتسلسل | 7 اختبارات Python و3 تكافؤ؛4ملفات بصفر أخطاء IFC4/EXPRESS وقراءة هندسة مستقلة صحيحة. قارئ IFC والمدقق ومستورد CAD لم تُغلق بعد |
...
آخر تشغيل كامل بعد C09e: 138 ملف اختبار، 123 نجاح / 7 فشل / 8 غير متحققة.
