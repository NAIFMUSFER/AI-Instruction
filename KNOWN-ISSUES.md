...
| first-party JavaScript, all modules | **2,125,449 B in 41 modules** |
| evaluated on first load (core + boot) | **1,659,580 B** |
|   of which core modules | **1,607,120 B in 29 modules** |
