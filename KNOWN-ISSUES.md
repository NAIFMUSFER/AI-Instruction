...
| first-party JavaScript, all modules | **1,944,452 B in 29 modules** |
| evaluated on first load (core + boot) | **1,478,583 B** |
|   of which core modules | **1,450,689 B in 17 modules** |
