...
| first-party JavaScript, all modules | **2,057,977 B in 37 modules** |
| evaluated on first load (core + boot) | **1,592,108 B** |
|   of which core modules | **1,545,806 B in 25 modules** |
