...
| first-party JavaScript, all modules | **1,971,009 B in 32 modules** |
| evaluated on first load (core + boot) | **1,505,140 B** |
|   of which core modules | **1,477,246 B in 20 modules** |
