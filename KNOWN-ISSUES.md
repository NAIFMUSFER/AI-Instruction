...
| first-party JavaScript, all modules | **2,125,957 B in 41 modules** |
| evaluated on first load (core + boot) | **1,660,088 B** |
|   of which core modules | **1,607,628 B in 29 modules** |
