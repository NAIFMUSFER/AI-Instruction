...
| first-party JavaScript, all modules | **2,079,439 B in 38 modules** |
| evaluated on first load (core + boot) | **1,613,570 B** |
|   of which core modules | **1,561,110 B in 26 modules** |
