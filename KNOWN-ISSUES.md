...
| first-party JavaScript, all modules | **2,126,785 B in 41 modules** |
| evaluated on first load (core + boot) | **1,660,916 B** |
|   of which core modules | **1,608,456 B in 29 modules** |
