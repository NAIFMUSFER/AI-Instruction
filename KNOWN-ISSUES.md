...
منتج منشور عند هذا التحديث هو C09e: bd6102dff48bb1513f4782baf3f3bb720755cd39.
...
| AUDIT-C19: تقرير أمانة IFC يخفي فقد الشكل | مفتوح ومثبت | استيراد L يفقد حدود الغرفة والبلاطة، والتقرير PASS وgeometry_fidelity=1.0؛ أدلة C09f |
...
آخر تشغيل كامل بعد C09f: 139 ملف اختبار، 124 نجاح / 7 فشل / 8 غير متحققة.
