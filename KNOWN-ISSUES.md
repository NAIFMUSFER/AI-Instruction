...
| first-party JavaScript, all modules | **2,126,836 B in 41 modules** |
| evaluated on first load (core + boot) | **1,660,967 B** |
|   of which core modules | **1,608,507 B in 29 modules** |
