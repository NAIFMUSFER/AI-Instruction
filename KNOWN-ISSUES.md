...
| AUDIT-C12: forklift يصنف مصعداً | مفتوح — مثبت حديثاً | acs_arch.py:264 وacs_relations.py:33؛ input محفوظ يخلق فتحة بلاطة وحافة اتصال رأسي لرافعة شوكية بسبب مطابقة lift كجزء من الكلمة |
