...
| | |
|---|---|
| index shell (`public/index.html`) | **51,492 B** |
| first-party JavaScript, all modules | **1,993,753 B in 32 modules** |
| evaluated on first load (core + boot) | **1,527,884 B** |
|   of which core modules | **1,481,736 B in 20 modules** |
| deferred until a panel is opened | **465,869 B in 6 modules** |
| share of first-party JS deferred | **23.4 %** |
