...
| first-party JavaScript, all modules | **2,125,107 B in 41 modules** |
| evaluated on first load (core + boot) | **1,659,238 B** |
|   of which core modules | **1,606,778 B in 29 modules** |
