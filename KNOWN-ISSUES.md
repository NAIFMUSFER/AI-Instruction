...
منتج منشور عند هذا التحديث هو C17: c75f80973c4eaea8ae6ac7f3513d25bcd5864161.
...
| AUDIT-C18: تصنيف جدران IFC | أُصلح مع حفظ كامل الهندسة | IfcWall عام، مع استمرار استيراد StandardCase؛ عينة IFC والمستودع صفر أخطاء مخطط/EXPRESS. هذا لا يغلق فقدان شكل المضلع C09e |
...
آخر تشغيل كامل بعد C18: 136 ملف اختبار، 121 نجاح / 7 فشل / 8 غير متحققة.
