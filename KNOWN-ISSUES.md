...
| first-party JavaScript, all modules | **2,055,644 B in 36 modules** |
| evaluated on first load (core + boot) | **1,589,775 B** |
|   of which core modules | **1,543,622 B in 24 modules** |
