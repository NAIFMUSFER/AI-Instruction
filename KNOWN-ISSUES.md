...
منتج منشور عند هذا التحديث هو C09d: c64bc9a69f3b7211c04f89b691951f0d1928cc30.
...
| AUDIT-C15: حقل أخير مفقود في الباب والنافذة IFC | مفتوح، ثبت مستقلاً | IfcOpenShell:خطآن؛ عدد القيم 12 بدلاً من13 |
...
آخر تشغيل كامل بعد C14: 132 ملف اختبار، 117 نجاح / 7 فشل / 8 غير متحققة.
