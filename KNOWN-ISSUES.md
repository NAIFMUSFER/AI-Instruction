...
| first-party JavaScript, all modules | **2,117,660 B in 41 modules** |
| evaluated on first load (core + boot) | **1,651,791 B** |
|   of which core modules | **1,599,331 B in 29 modules** |
| deferred until a panel is opened | **465,869 B in 6 modules** |
| share of first-party JS deferred | **22.0 %** |
