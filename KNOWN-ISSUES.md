...
| first-party JavaScript, all modules | **2,073,026 B in 38 modules** |
| evaluated on first load (core + boot) | **1,607,157 B** |
|   of which core modules | **1,560,855 B in 26 modules** |
